defmodule NASR.Entities.FixChartingInformationTest do
  use ExUnit.Case
  ...
  describe "new/1" do
    test "creates struct from real-world FIX_CHRT sample data" do
      ...
      result = NASR.Entities.FixChartingInformation.new(sample_data)
    ...
    test "handles empty date field" do
      ...
      result = NASR.Entities.FixChartingInformation.new(sample_data)
      assert result.eff_date == nil
    end

    test "type/0 returns correct type string" do
      assert NASR.Entities.FixChartingInformation.type() == "FIX_CHRT"
    end
  end
end