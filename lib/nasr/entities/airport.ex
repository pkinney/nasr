  ...
  * `:effective_date` - The 28 Day NASR Subscription Effective Date in format 'YYYY/MM/DD'
  ...
  def new(entity) do
    %__MODULE__{
      ...
      ownership_type_code: parse_ownership_type_code(Map.get(entity, "OWNERSHIP_TYPE_CODE")),
      facility_use_code: parse_facility_use_code(Map.get(entity, "FACILITY_USE_CODE")),
      ...
      elevation_method_code: parse_elevation_method_code(Map.get(entity, "ELEV_METHOD_CODE")),
      ...
      fss_on_facility_flag: convert_yn(Map.get(entity, "FSS_ON_ARPT_FLAG")),
      ...
      notam_service_flag: convert_yn(Map.get(entity, "NOTAM_FLAG")),
      activation_date: parse_date(Map.get(entity, "ACTIVATION_DATE")),
      airport_status_code: parse_airport_status_code(Map.get(entity, "ARPT_STATUS")),
      ...
      customs_entry_airport_flag: convert_yn(Map.get(entity, "CUST_FLAG")),
      customs_landing_rights_flag: convert_yn(Map.get(entity, "LNDG_RIGHTS_FLAG")),
      joint_use_agreement_flag: convert_yn(Map.get(entity, "JOINT_USE_FLAG")),
      military_landing_rights_flag: convert_yn(Map.get(entity, "MIL_LNDG_FLAG")),
      ...
      air_traffic_control_tower: parse_tower_type(Map.get(entity, "TWR_TYPE_CODE")),
      ...
      landing_fee_flag: convert_yn(Map.get(entity, "LNDG_FEE_FLAG")),
      medical_use_flag: convert_yn(Map.get(entity, "MEDICAL_USE_FLAG")),
      ...
      contract_fuel_available_flag: convert_yn(Map.get(entity, "CONTR_FUEL_AVBL")),
      transient_storage_buoy_flag: convert_yn(Map.get(entity, "TRNS_STRG_BUOY_FLAG")),
      transient_storage_hangar_flag: convert_yn(Map.get(entity, "TRNS_STRG_HGR_FLAG")),
      transient_storage_tiedown_flag: convert_yn(Map.get(entity, "TRNS_STRG_TIE_FLAG")),
      other_services: parse_other_services(Map.get(entity, "OTHER_SERVICES")),
      wind_indicator_flag: parse_wind_indicator_flag(Map.get(entity, "WIND_INDCR_FLAG")),
      icao_id: Map.get(entity, "ICAO_ID"),
      minimum_operational_network: Map.get(entity, "MIN_OP_NETWORK"),
      user_fee_flag: convert_yn(Map.get(entity, "USER_FEE_FLAG")),
