defmodule NASR.Entities.NavigationAidBaseData do
  ...
  def new(entry) do
    %__MODULE__{
      ...
      associated_city: entry.city_associated_with_the_navaid,
      associated_state_name: entry.state_name_where_associated_city_is_located,
      state_post_office_code: entry.state_post_office_code_where_associated,
      faa_region_code: entry.faa_region_responsible_for_navaid_code,
      country_name: entry.country_navaid_located_if_other_than_u_s,
      country_post_office_code: entry.country_post_office_code_navaid,
      navaid_owner_name: entry.navaid_owner_name_ex_u_s_navy,
      navaid_operator_name: entry.navaid_operator_name_ex_u_s_navy,
      common_system_usage: convert_yn(entry.common_system_usage_y_or_n),
      navaid_public_use: convert_yn(entry.navaid_public_use_y_or_n),
      navaid_class: entry.class_of_navaid,
      hours_of_operation: entry.hours_of_operation_of_navaid,
      high_altitude_artcc_id: entry.identifier_of_artcc_with_high_altitude_boundary_that_the_navaid,
      high_altitude_artcc_name: entry.name_of_artcc_with_high_altitude_boundary_that_the_navaid,
      low_altitude_artcc_id: entry.identifier_of_artcc_with_low_altitude_boundary_that_the_navaid,
      low_altitude_artcc_name: entry.name_of_artcc_with_low_altitude_boundary_that_the_navaid,
      ...
      tacan_latitude_seconds: entry.latitude_of_tacan_portion_of_vortac_when_tacan,
      tacan_longitude_formatted: entry.longitude_of_tacan_portion_of_vortac_when_tacan,
      tacan_longitude_seconds: entry.longitude_of_tacan_portion_of_vortac_when_tacan,
      elevation_tenth_foot_msl: safe_str_to_float(entry.elevation_in_tenth_of_a_foot_msl),
      magnetic_variation_degrees: entry.magnetic_variation_degrees_00_99,
      ...
      automatic_voice_identification: convert_yn(entry.automatic_voice_identification_feature),
      monitoring_category: safe_str_to_int(entry.monitoring_category),
      radio_voice_call: entry.radio_voice_call_name,
      tacan_channel: entry.channel_tacan_navaid_transmits_on,
      frequency: safe_str_to_float(entry.frequency_the_navaid_transmits_on),
      ...
      fan_marker_bearing: entry.true_bearing_of_major_axis_of_fan_marker,
      vor_standard_service_volume: entry.vor_standard_service_volume,
      dme_standard_service_volume: entry.dme_standard_service_volume,
      ...
      tweb_hours: entry.transcribed_weather_broadcast_hours_tweb,
      ...
      fss_hours_of_operation: entry.hours_of_operation_of_controlling_fss,
      ...
      navaid_restriction_flag: convert_yn(entry.navaid_restriction_flag),
      hiwas_flag: convert_yn(entry.hiwas_flag),
