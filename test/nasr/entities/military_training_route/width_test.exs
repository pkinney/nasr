defmodule NASR.Entities.MilitaryTrainingRoute.WidthTest do
  ...
  alias NASR.Entities.MilitaryTrainingRoute.Width

  describe "new/1" do
    test "creates struct from MTR width data sample" do
      sample_data = create_sample_data(%{})

      result = Width.new(sample_data)
    ...
    test "handles detailed segment width specifications" do
      ...
      assert result.width_text ==
               "6 NM EITHER SIDE FROM A TO B; 4 NM EITHER SIDE FROM B TO C; 2 NM EITHER SIDE FROM C TO D."
    end
