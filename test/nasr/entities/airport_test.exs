  ...
  describe "new/1" do
    ...
    test "handles facility use codes correctly" do
      test_cases = [
        {"PU", :public},
        {"PR", :private},
        # Parser returns string for unknown codes
        {"MI", "MI"},
        {"OTHER", "OTHER"}
      ]
    ...
    test "handles various airport types and characteristics" do
      ...
      result = Airport.new(major_airport)
      ...
      result = Airport.new(private_strip)
    ...
    test "handles coordinate edge cases" do
      ...
      result = Airport.new(alaska_data)
      ...
      result = Airport.new(hawaii_data)
    ...
    test "handles magnetic variation correctly" do
      ...
      result = Airport.new(east_variation)
      ...
      result = Airport.new(west_variation)
