defmodule NASR.Entities.ILSGlideSlopeData do
  @moduledoc "Entity struct for ILS3 (GLIDE SLOPE DATA) records"
  import NASR.Utils
  ...
  defstruct [
    ...
    :distance_source,
    :site_elevation,
    :glide_slope_class_type,
    :glide_slope_angle,
    :transmission_frequency,
    :runway_elevation_at_antenna
  ]
  ...
  @type t() :: %__MODULE__{
    ...
    glide_slope_class_type: :glide_slope | :glide_slope_dme | nil,
    glide_slope_angle: float() | nil,
    transmission_frequency: float() | nil,
    runway_elevation_at_antenna: float() | nil
  }
  ...
  def new(entry) do
    %__MODULE__{
      ...
      operational_status: convert_operational_status(entry.status_of_glide_slope_operational_ifr),
      operational_status_date: parse_date(entry.date_of_glide_slope_operational_status),
      latitude_formatted: entry[:latitude_of_glide_slope_transmitter_antenna_formatted] || entry.latitude_of_glide_slope_transmitter_antenna,
      latitude_seconds: entry.latitude_of_glide_slope_transmitter_antenna,
      longitude_formatted: entry[:longitude_of_glide_slope_transmitter_antenna_formatted] || entry.longitude_of_glide_slope_transmitter_antenna,
      longitude_seconds: entry.longitude_of_glide_slope_transmitter_antenna,
      position_source: convert_source_code(entry.indicating_source_of_latitude_longitude),
      distance_from_approach_end: safe_str_to_int(entry.distance_of_glide_slope_transmitter_antenna),
      distance_from_centerline: safe_str_to_int(entry.of_glide_slope_transmitter_antenna),
      ...
      site_elevation: safe_str_to_float(entry.elevation_of_glide_slope_transmitter_antenna),
      glide_slope_class_type: convert_glide_slope_class(entry.glide_slope_class_type),
      glide_slope_angle: safe_str_to_float(entry.glide_slope_angle_in_degrees),
      transmission_frequency: safe_str_to_float(entry.glide_slope_transmission_frequency),
      runway_elevation_at_antenna: safe_str_to_float(entry.elevation_of_runway_at_point_adjacent_to_the)
    }
  end
  ...
  defp convert_glide_slope_class("GLIDE SLOPE"), do: :glide_slope
  defp convert_glide_slope_class("GLIDE SLOPE/DME"), do: :glide_slope_dme
  defp convert_glide_slope_class(_), do: nil
end