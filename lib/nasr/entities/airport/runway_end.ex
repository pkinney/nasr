  ...
  * `:runway_end_lahso_position_date` - Date of LAHSO position survey
  ...
  def new(entity) do
    %__MODULE__{
      ...
      true_alignment: safe_str_to_int(Map.get(entity, "TRUE_ALIGNMENT")),
      ils_type: Map.get(entity, "ILS_TYPE"),
      right_hand_traffic_pattern_flag: convert_yn(Map.get(entity, "RIGHT_HAND_TRAFFIC_PAT_FLAG")),
      runway_marking_type_code: Map.get(entity, "RWY_MARKING_TYPE_CODE"),
      runway_marking_condition: Map.get(entity, "RWY_MARKING_COND"),
      runway_end_latitude_degrees: safe_str_to_int(Map.get(entity, "RWY_END_LAT_DEG")),
      runway_end_latitude_minutes: safe_str_to_int(Map.get(entity, "RWY_END_LAT_MIN")),
      runway_end_latitude_seconds: safe_str_to_float(Map.get(entity, "RWY_END_LAT_SEC")),
      runway_end_latitude_hemisphere: parse_hemisphere(Map.get(entity, "RWY_END_LAT_HEMIS")),
      latitude_decimal: safe_str_to_float(Map.get(entity, "LAT_DECIMAL")),
      runway_end_longitude_degrees: safe_str_to_int(Map.get(entity, "RWY_END_LONG_DEG")),
      runway_end_longitude_minutes: safe_str_to_int(Map.get(entity, "RWY_END_LONG_MIN")),
      runway_end_longitude_seconds: safe_str_to_float(Map.get(entity, "RWY_END_LONG_SEC")),
      runway_end_longitude_hemisphere: parse_hemisphere(Map.get(entity, "RWY_END_LONG_HEMIS")),
      longitude_decimal: safe_str_to_float(Map.get(entity, "LONG_DECIMAL")),
      runway_end_elevation: safe_str_to_float(Map.get(entity, "RWY_END_ELEV")),
      threshold_crossing_height: safe_str_to_int(Map.get(entity, "THR_CROSSING_HGT")),
      visual_glide_path_angle: safe_str_to_int(Map.get(entity, "VISUAL_GLIDE_PATH_ANGLE")),
      displaced_threshold_latitude_degrees: safe_str_to_int(Map.get(entity, "DISPLACED_THR_LAT_DEG")),
      displaced_threshold_latitude_minutes: safe_str_to_int(Map.get(entity, "DISPLACED_THR_LAT_MIN")),
      displaced_threshold_latitude_seconds: safe_str_to_float(Map.get(entity, "DISPLACED_THR_LAT_SEC")),
      displaced_threshold_latitude_hemisphere: parse_hemisphere(Map.get(entity, "DISPLACED_THR_LAT_HEMIS")),
      latitude_displaced_threshold_decimal: safe_str_to_float(Map.get(entity, "LAT_DISPLACED_THR_DECIMAL")),
      displaced_threshold_longitude_degrees: safe_str_to_int(Map.get(entity, "DISPLACED_THR_LONG_DEG")),
      displaced_threshold_longitude_minutes: safe_str_to_int(Map.get(entity, "DISPLACED_THR_LONG_MIN")),
      displaced_threshold_longitude_seconds: safe_str_to_float(Map.get(entity, "DISPLACED_THR_LONG_SEC")),
      displaced_threshold_longitude_hemisphere: parse_hemisphere(Map.get(entity, "DISPLACED_THR_LONG_HEMIS")),
      longitude_displaced_threshold_decimal: safe_str_to_float(Map.get(entity, "LONG_DISPLACED_THR_DECIMAL")),
      displaced_threshold_elevation: safe_str_to_float(Map.get(entity, "DISPLACED_THR_ELEV")),
      displaced_threshold_length: safe_str_to_int(Map.get(entity, "DISPLACED_THR_LEN")),
      touchdown_zone_elevation: safe_str_to_int(Map.get(entity, "TDZ_ELEV")),
      visual_glide_slope_indicator_code: Map.get(entity, "VGSI_CODE"),
      runway_visual_range_equipment_code: Map.get(entity, "RWY_VISUAL_RANGE_EQUIP_CODE"),
      runway_visibility_value_equipment_flag: convert_yn(Map.get(entity, "RWY_VSBY_VALUE_EQUIP_FLAG")),
      approach_lighting_system_code: Map.get(entity, "APCH_LGT_SYSTEM_CODE"),
      runway_end_lights_flag: convert_yn(Map.get(entity, "RWY_END_LGTS_FLAG")),
      centerline_lights_available_flag: convert_yn(Map.get(entity, "CNTRLN_LGTS_AVBL_FLAG")),
      touchdown_zone_lights_available_flag: convert_yn(Map.get(entity, "TDZ_LGT_AVBL_FLAG")),
      obstruction_type: Map.get(entity, "OBSTN_TYPE"),
      obstruction_marked_code: Map.get(entity, "OBSTN_MRKD_CODE"),
      far_part_77_code: Map.get(entity, "FAR_PART_77_CODE"),
      obstruction_clearance_slope: safe_str_to_int(Map.get(entity, "OBSTN_CLNC_SLOPE")),
      obstruction_height: safe_str_to_int(Map.get(entity, "OBSTN_HGT")),
      distance_from_threshold: safe_str_to_int(Map.get(entity, "DIST_FROM_THR")),
      centerline_offset: safe_str_to_int(Map.get(entity, "CNTRLN_OFFSET")),
      centerline_direction_code: Map.get(entity, "CNTRLN_DIR_CODE"),
      runway_gradient: safe_str_to_float(Map.get(entity, "RWY_GRAD")),
      runway_gradient_direction: Map.get(entity, "RWY_GRAD_DIRECTION"),
      runway_end_position_source: Map.get(entity, "RWY_END_PSN_SOURCE"),
      runway_end_position_date: parse_date(Map.get(entity, "RWY_END_PSN_DATE")),
      runway_end_elevation_source: Map.get(entity, "RWY_END_ELEV_SOURCE"),
      runway_end_elevation_date: parse_date(Map.get(entity, "RWY_END_ELEV_DATE")),
      displaced_threshold_position_source: Map.get(entity, "DSPL_THR_PSN_SOURCE"),
      runway_end_displaced_threshold_position_date: parse_date(Map.get(entity, "RWY_END_DSPL_THR_PSN_DATE")),
      displaced_threshold_elevation_source: Map.get(entity, "DSPL_THR_ELEV_SOURCE"),
      runway_end_displaced_threshold_elevation_date: parse_date(Map.get(entity, "RWY_END_DSPL_THR_ELEV_DATE")),
      touchdown_zone_elevation_source: Map.get(entity, "TDZ_ELEV_SOURCE"),
      runway_end_touchdown_zone_elevation_date: parse_date(Map.get(entity, "RWY_END_TDZ_ELEV_DATE")),
      takeoff_run_available: safe_str_to_int(Map.get(entity, "TKOF_RUN_AVBL")),
      takeoff_distance_available: safe_str_to_int(Map.get(entity, "TKOF_DIST_AVBL")),
      accelerate_stop_distance_available: safe_str_to_int(Map.get(entity, "ACLT_STOP_DIST_AVBL")),
      landing_distance_available: safe_str_to_int(Map.get(entity, "LNDG_DIST_AVBL")),
      lahso_available_landing_distance: safe_str_to_int(Map.get(entity, "LAHSO_ALD")),
      runway_end_intersect_lahso: Map.get(entity, "RWY_END_INTERSECT_LAHSO"),
      lahso_description: Map.get(entity, "LAHSO_DESC"),
      lahso_latitude: Map.get(entity, "LAHSO_LAT"),
      latitude_lahso_decimal: safe_str_to_float(Map.get(entity, "LAT_LAHSO_DECIMAL")),
      lahso_longitude: Map.get(entity, "LAHSO_LONG"),
      longitude_lahso_decimal: safe_str_to_float(Map.get(entity, "LONG_LAHSO_DECIMAL")),
