  ...
  * `:glideslope_frequency` - Glideslope frequency (MHz)
  ...
  def new(entity) do
    %__MODULE__{
      ...
      glideslope_type_code: Map.get(entity, "G_S_TYPE_CODE"),
      glideslope_angle: safe_str_to_int(Map.get(entity, "G_S_ANGLE")),
      glideslope_frequency: safe_str_to_float(Map.get(entity, "G_S_FREQ"))
    }
  end
