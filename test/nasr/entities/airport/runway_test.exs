defmodule NASR.Entities.Airport.RunwayTest do
  ...
  describe "new/1" do
    test "creates struct from airport runway data" do
      ...
      assert result.runway_length == 11_095
      ...
      assert result.single_wheel_weight == 300_000
      assert result.dual_wheel_weight == 450_000
      assert result.dual_tandem_weight == 700_000
      assert result.double_dual_tandem_weight == 850_000
    ...
    test "converts numeric fields correctly" do
      ...
      assert result.single_wheel_weight == 75_000
      assert result.dual_wheel_weight == 100_000
      assert result.dual_tandem_weight == 150_000
      assert result.double_dual_tandem_weight == 200_000
    end
