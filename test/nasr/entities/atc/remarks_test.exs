defmodule NASR.Entities.ATC.RemarksTest do
  ...
  describe "new/1" do
    ...
    test "handles different facility types" do
      ...
      assert non_atct_result.remark_text ==
    ...
    test "handles multiple remarks" do
      ...
      assert result1.remark_text ==
               "APCH/DEP CTL SVC PRVDD BY HOUSTON ARTCC (ZHU) ON FREQS 125.175/285.575 (LUFKIN RCAG)."

      assert result2.remark_number == 2

      assert result2.remark_text ==
               "PPR FOR UNSCHD OPS WITH MORE THAN 30 PASSENGER SEATS; CALL ARPT MANAGER 936-555-0123."
    end
