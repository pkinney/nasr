  ...
  * `:remark` - Free form text that further describes a specific information item
  ...
  def new(entity) do
    %__MODULE__{
      ...
      from_point: Map.get(entity, "FROM_POINT"),
      from_point_type: Map.get(entity, "FROM_PT_TYPE"),
      nav_name: Map.get(entity, "NAV_NAME"),
      nav_city: Map.get(entity, "NAV_CITY"),
      ...
      to_point: Map.get(entity, "TO_POINT"),
      magnetic_course: safe_str_to_float(Map.get(entity, "MAG_COURSE")),
      opposite_magnetic_course: safe_str_to_float(Map.get(entity, "OPP_MAG_COURSE")),
      magnetic_course_distance: safe_str_to_float(Map.get(entity, "MAG_COURSE_DIST")),
      changeover_point: Map.get(entity, "CHGOVR_PT"),
      changeover_point_name: Map.get(entity, "CHGOVR_PT_NAME"),
      changeover_point_distance: safe_str_to_float(Map.get(entity, "CHGOVR_PT_DIST")),
      airway_segment_gap_flag: convert_yn(Map.get(entity, "AWY_SEG_GAP_FLAG")),
      signal_gap_flag: convert_yn(Map.get(entity, "SIGNAL_GAP_FLAG")),
      dogleg: convert_yn(Map.get(entity, "DOGLEG")),
      next_mea_point: Map.get(entity, "NEXT_MEA_PT"),
      minimum_enroute_altitude: safe_str_to_int(Map.get(entity, "MIN_ENROUTE_ALT")),
      minimum_enroute_altitude_direction: Map.get(entity, "MIN_ENROUTE_ALT_DIR"),
      minimum_enroute_altitude_opposite: safe_str_to_int(Map.get(entity, "MIN_ENROUTE_ALT_OPPOSITE")),
      minimum_enroute_altitude_opposite_direction: Map.get(entity, "MIN_ENROUTE_ALT_OPPOSITE_DIR"),
      gps_minimum_enroute_altitude: safe_str_to_int(Map.get(entity, "GPS_MIN_ENROUTE_ALT")),
      gps_minimum_enroute_altitude_direction: Map.get(entity, "GPS_MIN_ENROUTE_ALT_DIR"),
      gps_minimum_enroute_altitude_opposite: safe_str_to_int(Map.get(entity, "GPS_MIN_ENROUTE_ALT_OPPOSITE")),
      gps_mea_opposite_direction: Map.get(entity, "GPS_MEA_OPPOSITE_DIR"),
      dd_iru_mea: safe_str_to_int(Map.get(entity, "DD_IRU_MEA")),
      dd_iru_mea_direction: Map.get(entity, "DD_IRU_MEA_DIR"),
      dd_i_mea_opposite: safe_str_to_int(Map.get(entity, "DD_I_MEA_OPPOSITE")),
      dd_i_mea_opposite_direction: Map.get(entity, "DD_I_MEA_OPPOSITE_DIR"),
      minimum_obstruction_clearance_altitude: safe_str_to_int(Map.get(entity, "MIN_OBSTN_CLNC_ALT")),
      minimum_crossing_altitude: safe_str_to_int(Map.get(entity, "MIN_CROSS_ALT")),
      minimum_crossing_altitude_direction: Map.get(entity, "MIN_CROSS_ALT_DIR"),
      minimum_crossing_altitude_nav_point: Map.get(entity, "MIN_CROSS_ALT_NAV_PT"),
      minimum_crossing_altitude_opposite: safe_str_to_int(Map.get(entity, "MIN_CROSS_ALT_OPPOSITE")),
      minimum_crossing_altitude_opposite_direction: Map.get(entity, "MIN_CROSS_ALT_OPPOSITE_DIR"),
      minimum_reception_altitude: safe_str_to_int(Map.get(entity, "MIN_RECEP_ALT")),
      maximum_authorized_altitude: safe_str_to_int(Map.get(entity, "MAX_AUTH_ALT")),
      mea_gap: Map.get(entity, "MEA_GAP"),
      required_navigation_performance: Map.get(entity, "REQD_NAV_PERFORMANCE"),
