defmodule NASR.Entities.MilitaryTrainingRoute.StandardOperatingProcedureTest do
  ...
  alias NASR.Entities.MilitaryTrainingRoute.StandardOperatingProcedure

  describe "new/1" do
    test "creates struct from MTR SOP data sample" do
      sample_data = create_sample_data(%{})

      result = StandardOperatingProcedure.new(sample_data)
  ...
  describe "type/0" do
    test "returns correct CSV filename" do
      assert StandardOperatingProcedure.type() == "MTR_SOP"
    end
  end
